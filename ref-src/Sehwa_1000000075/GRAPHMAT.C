...
void main()
{
	...
	while(1)
	{
		...
		switch(c)
		{
			case 0x9ff  : 	rotate(p,0);
							break;
			case 0x8ff  : 	rotate(p,1);
							break;
			case 0x6ff  : 	rotate(p,2);
							break;
			case 0x4d00 : 	rotate(p,3);
							break;
			case 0x4800 : 	rotate(p,4);
							break;
			case 0x4b00 : 	rotate(p,5);
							break;
			case 0x5000 : 	rotate(p,6);
							break;
		}
	}
	closegraph();
