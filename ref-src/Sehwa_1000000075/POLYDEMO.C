...
void main(int argc, char *argv[])
    ...
    t1 = get_tick();
    for (i=0; i < LOOP; i++) eval_horner_simple(c, 2.5);
    t2 = get_tick();
    ...
    t1 = get_tick();
    for(i=0; i < LOOP; i++) eval_horner_math(c, 2.5);
    t2 = get_tick();
    printf("  Time : %ld", diff_tick(t1, t2));
    ...
    t1 = get_tick();
    for(i=0; i < LOOP; i++) eval_horner_modified(c, 2.5);
    t2 = get_tick();
    printf("  Time : %ld", diff_tick(t1, t2));
    ...
    printf("\nbrust-force -- pow_simple  Value : %lg",
	    eval_simple(c, 2.5));
    t1 = get_tick();
    for(i = 0; i < LOOP; i++) eval_simple(c, 2.5);
    t2 = get_tick();
    printf("  Time : %ld", diff_tick(t1, t2));
    ...
    printf("\nbrust-force -- pow<math> Value : %lg",
	   eval_math(c, 2.5));
    t1 = get_tick();
    for(i = 0;i < LOOP; i++) eval_math(c, 2.5);
    t2 = get_tick();
    printf("  Time : %ld", diff_tick(t1, t2));
    ...
    printf("\nbrust-force -- pow_modified Value : %lg",
	   eval_modified(c, 2.5));
    t1 = get_tick();
    for(i = 0; i < LOOP; i++) eval_modified(c, 2.5);
    t2 = get_tick();
    printf("  Time : %ld", diff_tick(t1, t2));
